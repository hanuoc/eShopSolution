...
namespace eShopSolution.Application.Catalog.Products
{
	public class ManageProductService : IManageProductService
	{
		...
		{
			var product = await _context.Products.FindAsync(productId);
			var productTranslation = await _context.ProductTranslations.FirstOrDefaultAsync(x => x.LanguageId == languageId && productId == productId);
		...
		public async Task<int> RemoveImage(int imageId)
		{
			...
			if (productImage == null) throw new EShopException($"Cannot find product Image: {imageId}");
		...
		public async Task<int> Update(ProductUpdateRequest request)
		{
			...
			if (product == null || productTranslations == null) throw new EShopException($"Cannot find product {request.Id}");
